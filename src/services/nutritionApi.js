...
const FALLBACK_DRINKS = [
  {
    ...
    name: "Espresso",
    brand: "Generic",
    water: { value: 98, unit: "g" },
    caffeine: { value: 212, unit: "mg" },
    vitaminC: null,
    sugar: null,
  },
  {
  ...
  },
  {
    ...
    name: "Orange Juice",
    brand: "Generic",
    water: { value: 88, unit: "g" },
    caffeine: null,
    vitaminC: { value: 50, unit: "mg" },
    sugar: { value: 9, unit: "g" },
  },
  {
    id: "mock-5",
    name: "Cola Soda",
    brand: "Generic",
    water: { value: 90, unit: "g" },
    caffeine: { value: 8, unit: "mg" },
    vitaminC: null,
    sugar: { value: 11, unit: "g" },
  },
  {
    id: "mock-6",
    name: "Energy Drink",
    brand: "Monster",
    water: { value: 85, unit: "g" },
    caffeine: { value: 32, unit: "mg" },
    ...
    .map((p) => {
      return {
        ...
        vitaminC: p.nutriments?.["vitamin-c_100g"]
          ? { value: p.nutriments["vitamin-c_100g"] * 1000, unit: "mg" }
          : null,
        sugar: p.nutriments?.sugars_100g
          ? { value: p.nutriments.sugars_100g, unit: "g" }
          : null,
      };
    })
    .filter((p) => p.name);
